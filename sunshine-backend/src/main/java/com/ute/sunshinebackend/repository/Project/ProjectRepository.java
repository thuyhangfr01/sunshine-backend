...
public interface ProjectRepository extends JpaRepository<Project, Long> {
    @Query("SELECT new com.ute.sunshinebackend.dto.ProjectListDto(a.name, a.details, b.name, a.numVolunteers, c.name, a.position, a.startTime, a.endTime, a.holdTime) "
    ...
    @Query(value = "SELECT new com.ute.sunshinebackend.dto.ProjectListDto(a.name, a.details, b.name, a.numVolunteers, c.name, a.position, a.startTime, a.endTime, a.holdTime) "
