...
@Data
public class ContributionImportDto {
    @Id
    private String id;
    private Long userId;
    ...
    private long statusMoneyId = 3;
    private long receivedAmount = 0;
    private long statueArtifactId = 1;
    private String paymentType = "Tiền mặt";

    private String receiver = "Qũy Sunshine";
    private Date createdAt = Timestamp.valueOf(LocalDateTime.now());
    public ContributionImportDto() {}

    public ContributionImportDto(String id, Long userId, Long projectId, String nickname, String projectName, String messages, ContributionMoney contributionMoney, long amountMoney, long statusMoneyId) {
        this.id = id;
        this.userId = userId;
    ...
    public ContributionImportDto(String id, Long userId, Long projectId, String nickname, String projectName, String messages, ContributionMoney contributionMoney, List<ContributionArtifact> contributionArtifacts, long amountMoney, long statusMoneyId, long receivedAmount, long statueArtifactId) {
        this.id = id;
        this.userId = userId;
        this.projectId = projectId;
        this.nickname = nickname;
